...
require 'shadow_input_mode_clear_custom_leds' src/schwung_shim.c 'input module switch clears custom pad ownership'
...
require 'MODULES_ROOT.*/input_modes' src/shadow/shadow_ui.js 'input mode metadata lookup prefers input_modes directory'
...
require 'len > 65536' src/host/module_manager.c 'module manager 64KB module.json cap'
